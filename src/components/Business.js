...
class Business extends Component {
    ...
    componentDidMount(){
        let url='https://newsapi.org/v2/top-headlines?category=business&language=en&pageSize=100&apiKey=8f876b30a67c4bb6bb9079b83568ab6b'
    ...
    render() {
        ...
        return (
            <div>
                <h1 id='h1heading'>top Business news {'>'}{'>'}{'>'}{'>'}</h1>
